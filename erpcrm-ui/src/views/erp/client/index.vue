<template>
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="91px">
    ...
    <el-table v-loading="loading" :data="clientList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="客户ID" prop="id"/>
      <el-table-column align="center" label="客户名称" prop="clientNickname"/>
      <el-table-column align="center" label="客户手机" prop="clientPhone"/>
      <el-table-column align="center" label="客户收货地址" prop="shippingAddress"/>
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules"  style="width: 468px; padding-right: 8px;">
        <el-form-item label="客户名称" prop="clientNickname">
        ...
        <el-form-item label="客户收货地址" prop="shippingAddress"  style="width: 468px; padding-right: 8px;">
