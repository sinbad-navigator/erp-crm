  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="68px">
      <el-form-item label="日期查询" prop="createTime">
        <el-date-picker v-model="daterangeCreateTime" end-placeholder="结束日期" range-separator="-" size="small"
                        start-placeholder="开始日期" style="width: 240px" type="daterange"
      ...
      <el-form-item label="业务员" prop="owner">
        <el-select v-model="queryParams.owner" clearable placeholder="请选择业务员">
          <el-option v-for="owner in ownerList" :key="owner.owner" :label="owner.nickName"
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="left" label="客户名称" prop="customerName"/>
      <el-table-column align="left" label="订单金额" prop="amount"/>
      <el-table-column align="left" label="负责人" prop="owner"/>
      ...
      <el-table-column align="center" class-name="small-padding fixed-width" label="操作">
        <template slot-scope="scope">
          <el-button v-if="scope.row.status==0" v-hasPermi="['crm:order:approve']" icon="el-icon-edit" size="mini"
                     type="text" @click="handleApprove(scope.row)">审核通过
          </el-button>
          <el-button v-hasPermi="['crm:order:remove']" icon="el-icon-delete" size="mini" type="text"
