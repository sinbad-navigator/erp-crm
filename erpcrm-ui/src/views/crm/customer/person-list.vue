<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="customerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column :show-overflow-tooltip="true" align="/person-listcenter" label="创建时间" prop="createTime"
                       width="180">
        <template slot-scope="scope">
      ...
      <el-table-column align="left" class="small-padding" fixed="right" label="操作" width="250px">
        <template slot-scope="scope">
          <el-button v-hasPermi="['crm:customer:comment']" icon="el-icon-edit-outline" size="mini" type="text"
