<template>
  ...
  <el-dialog :close-on-click-modal="false" :loading="loading" :title="title" :visible.sync="openTransfer"
             append-to-body width="400px" @close="handleClose" @open="handleOpen">
