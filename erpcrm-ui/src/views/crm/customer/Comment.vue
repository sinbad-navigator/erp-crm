<template>
  ...
  <el-dialog :close-on-click-modal="false" :loading="loading" :title="title" :visible.sync="openComment"
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="120px">
      ...
      <el-form-item label="下次跟进时间" prop="nextFollowupTime">
        <el-date-picker v-model="form.nextFollowupTime" :picker-options="nextFollowTimePicker" clearable placeholder="选择下次跟进时间"
