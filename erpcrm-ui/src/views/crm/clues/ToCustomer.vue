<template>
  ...
  <el-dialog :close-on-click-modal="false" :loading="loading" :title="title" :visible.sync="openCustomer"
             append-to-body width="680px" @close="handleClose" @open="handleOpen">
    <el-form ref="form" :model="form" :rules="rules" label-width="120px">
      <el-row>
        <el-col :span="12">
          <el-form-item label="线索名称" prop="cluesName">
            <el-input v-model="form.cluesName" :disabled="true" placeholder="请输入客户名称"/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="联系电话" prop="phone">
            <el-input v-model="form.phone" :disabled="true" placeholder="请输入联系电话"/>
          </el-form-item>
        </el-col>
      </el-row>
