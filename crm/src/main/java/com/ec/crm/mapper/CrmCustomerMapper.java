...
public interface CrmCustomerMapper {
     ...
     * @return
     */
    int customerToPoolByIds(@Param("ids") Long[] ids, @Param("poolType") String poolType, @Param("status") String status, @Param("username")String username, @Param("pooltime")Date pooltime);
